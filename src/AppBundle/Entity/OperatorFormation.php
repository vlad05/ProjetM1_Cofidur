 ...
 * @ORM\Entity(repositoryClass="AppBundle\Repository\OperatorFormationRepository")
 */
class OperatorFormation
{
     ...
     *
     * @param \AppBundle\Entity\OperatorCategory $operatorcategory
     *
     * @return OperatorFormation
     */
    public function addOperatorcategory(\AppBundle\Entity\OperatorCategory $operatorcategory)
    {
     ...
     * @param \AppBundle\Entity\OperatorCategory $operatorcategory
     */
    public function removeOperatorcategory(\AppBundle\Entity\OperatorCategory $operatorcategory)
    {
