 ...
 * @ORM\Entity(repositoryClass="AppBundle\Repository\OperatorTaskRepository")
 */
class OperatorTask
{
    /**
     ...
     * @return OperatorTask
     */
    public function setOperatorcategory(\AppBundle\Entity\OperatorCategory $operatorcategory = null)
    {
     ...
     *
     * @return \AppBundle\Entity\OperatorCategory
     */
