...
class CategoryController extends Controller
{
    ...
    public function addAction(Request $request, $idForm)
    {
        ...
        return $this->render('AppBundle:Page/Category:category_add.html.twig', array(
    ...
    public function editAction(Request $request, $idCat)
    {
        ...
        return $this->render('AppBundle:Page/Category:category_edit.html.twig',
            ['form' => $form->createView()]
        );
    }
    ...
    public function deleteAction($idCat)
    {
        ...
        return $this->redirectToRoute('AppBundle_formation_show', array('idForm' => $idForm));
    }
